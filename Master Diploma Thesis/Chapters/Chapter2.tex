...
\section{Mathematical Analysis}
    ...
    \begin{definition}\label{def:2.29}
        \cite{NUSSBAUM1983243} A smooth Nussbaum-type function $\mathcal{N}(\cdot)$ if it has the following properties
        \begin{equation*}
            \left\{\begin{matrix}
                \limsup_{\zeta \to \infty} \left(\frac{1}{\zeta} \int_{0}^{\zeta}\mathcal{N}(s)ds\right) = + \infty \\
                \liminf_{\zeta \to \infty} \left(\frac{1}{\zeta} \int_{0}^{\zeta}\mathcal{N}(s)ds\right) = - \infty
            \end{matrix}} \right
        \end{equation*}
    \end{definition}
\section{Lyapunov Stability Theory}
    ...
    \begin{definition}\label{def:2.33}
